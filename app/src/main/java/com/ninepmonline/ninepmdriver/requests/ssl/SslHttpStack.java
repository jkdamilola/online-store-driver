...
import com.ninepmonline.ninepmdriver.requests.MultiPartRequest;
...
import static org.apache.http.cookie.params.CookieSpecPNames.DATE_PATTERNS;
...
class LenientCookieSpec extends BrowserCompatSpec {
    public LenientCookieSpec() {
        super();
        registerAttribHandler(ClientCookie.EXPIRES_ATTR, new BasicExpiresHandler(new String[]{DATE_PATTERNS}) {
            @Override
