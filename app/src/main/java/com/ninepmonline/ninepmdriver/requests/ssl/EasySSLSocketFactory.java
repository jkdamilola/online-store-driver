package com.ninepmonline.ninepmdriver.requests.ssl;
...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        try {
        	...
        	InputStream clientStream = AppController.getContext().getResources().openRawResource(R.raw.ninepm);
        	char[] password = "damilola91".toCharArray();
	        ...
	        InputStream instream = AppController.getContext().getResources().openRawResource(R.raw.ninepmonline);

	        try {
	            trustStore.load(instream, "damilola91".toCharArray());
	        } catch (Exception e) {
	            e.printStackTrace();
	        } finally {
